...
The third step can be interpreted as a constrained categorical form of \term{tensor completion}: we do not impute arbitrary values, but instead propose named dishes for previously unoccupied cells under hard ontological constraints.

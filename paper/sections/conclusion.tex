...
Future work can therefore extend the same tensor formalism while keeping the convention that salad occupies the \texttt{starch\_type=none} slice, the rice exception, and starch-based mono-food boundary cases explicit.

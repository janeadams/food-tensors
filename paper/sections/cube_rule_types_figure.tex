...
\definecolor{starchfill}{RGB}{183,226,235}
\definecolor{starchdark}{RGB}{110,175,190}
...
\end{scope}
\end{tikzpicture}
\caption{Cube-type morphology schematics for the nine categories on axis $i$. The blue regions indicate structural starch placement; the drawings are schematic rather than literal geometric reconstructions.}

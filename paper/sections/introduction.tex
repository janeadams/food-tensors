...
The Cube Rule of Food~\cite{arko_cube_rule_food} (\url{https://cuberule.com/}) is a morphology-based classification scheme that assigns a dish according to where structural starch appears on the six faces of an idealized cube.
...
Figure~\ref{fig:cube-rule-types} summarizes the nine cube types schematically.
